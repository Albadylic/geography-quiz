...
export function save(state: PersistedStateV2, adapter: StorageAdapter = defaultAdapter()): void {
 ...
 */
function repair(state: PersistedStateV2): PersistedStateV2 {
  const base = emptyState();
  const repaired: PersistedStateV2 = {
